...
img_elon = face_recognition.load_image_file('images/Arju.jpg')
...
# Doing the same with 
test_img_elon = face_recognition.load_image_file('images/c634fd63-b564-4187-8877-56536b227320.jpg')
# we get the image in BGR and library understands it into RGB's. Converting the image into RGB
...
cv2.rectangle(test_img_elon, (face_loc_test[3], face_loc_test[0]), (face_loc_test[1], face_loc_test[2]), (255,255,0), 2)
...
cv2.putText(test_img_elon, f'{results} {round(face_dis[0],2)} ', (face_loc_test[3], face_loc_test[0]), cv2.FONT_HERSHEY_COMPLEX,0.5, (255,255,0),2)
